...
- **Stakeholder reporting added 9/4:** the shared [FY27 Fabric Production Tracker](https://microsoft-my.sharepoint.com/personal/sfinkelstein_microsoft_com/_layouts/15/Doc.aspx?sourcedoc=%7B86F378C0-619E-464E-97DA-9B300F436624%7D&file=Fabric%20Production%20Tracker.xlsx&action=default&mobileredirect=true&DefaultItemOpen=1) now opens to a color-coded Stakeholder View with neutral status language and direct ADO links. A durable Windows task runs Mondays at 10:00 AM Pacific to create and verify an Outlook status draft to Alyssa Phillips and Terence O'Shea, with Sara CC'd; it never sends automatically.
