...
- **Yitzhak Kesselman short 237659 — captions in progress 9/2:** proofread all 26 cues, corrected 17 cue lines, generated synchronized SRT/VTT/TTML files, and attached all three to the Episode. The correct final edit is `https://f.io/3JUptmVu`; the proofed-caption review is `https://f.io/w-uG5yep`. A burned-in-caption version is still required before preparing the final-approval email.
