...
- **Episode 236856 publishing risk (checked 8/25):** [Power BI Agent Skills with Swetha Mannepalli and Emily Lisa](https://dev.azure.com/devrel/Studios/_workitems/edit/236856) is scheduled to publish 8/28. The final file exists, but Video title (External), Video description (External), resource links, chapter markers, speaker social links, thumbnail link, and caption link are blank. Its Publishing child remains `New`, so the existing publishing-ready watcher has not fired. V2 comments were due 8/21 and final delivery was due 8/24; the missed V2 reminder was recovered as a verified Outlook draft, sent by Sara, and copied to the Episode discussion.
