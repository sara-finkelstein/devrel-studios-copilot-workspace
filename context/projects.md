...
- **Transcript caption conformance staged 9/2:** [Draft PR #247](https://github.com/microsoft/mvp-copilot-plugins/pull/247) adds a deterministic `transcript-proofread` formatter enforcing 34 characters per line and two lines per cue, protected product/presenter phrases, balanced cue splitting, minimum readable split durations, synchronized SRT/VTT/TTML output, and playback-review guidance. Tracked by [Issue #245](https://github.com/microsoft/mvp-copilot-plugins/issues/245); local and canonical repository validation pass.
