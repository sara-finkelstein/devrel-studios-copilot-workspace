...
| `fabric-production-schedule` | Manages FTTF and Fabric Executive Insights timelines, Outlook review/publication calendar entries, review drafts, V2 reminders, and Teams alerts when an FY27 Publishing child moves from New to In Progress. | Personal/local — [open skill](file:///C:/Users/sfinkelstein/.copilot/skills/fabric-production-schedule/SKILL.md); publishing-ready watcher active |
