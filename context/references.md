...
## Team Resources
- [Cross charge — OneNote “How Tos” page](https://microsoft-my.sharepoint.com/personal/sfinkelstein_microsoft_com/_layouts/15/Doc.aspx?action=edit&mobileredirect=true&wdorigin=Sharepoint&DefaultItemOpen=1&sourcedoc=%7B093f8a91-a3f9-49d3-a6b4-c53afacc4de5%7D&wd=target%28%2FHow%20Tos.one%2F%29&wdpartid=%7B283dd016-2daf-01f0-0dbb-820dad92f0e6%7D%7B1%7D&wdsectionfileid=%7Bb6b43cd3-c189-4714-b0dc-fdf643575320%7D) — authoritative page titled **“Cross charge (most recent at bottom)”**. Start by obtaining the client’s account number and IO code, use the table structure on the page, confirm acceptance and end-of-quarter processing, then follow the latest instructions at the bottom.
...
| `communication-history-to-ado` | Copies exact Teams or Outlook communication into an ADO Discussion with live recency verification, deduplication, compact Subject/Date/To/From headers, and image rendering for complex tables. This presentation format must carry into a future team version. | Personal local skill — [open skill](file:///C:/Users/sfinkelstein/.copilot/skills/communication-history-to-ado/SKILL.md) |
...
- **FY27 Fabric Production Tracker:** [Open the current workbook](https://microsoft-my.sharepoint.com/personal/sfinkelstein_microsoft_com/_layouts/15/Doc.aspx?sourcedoc=%7B86F378C0-619E-464E-97DA-9B300F436624%7D&file=Fabric%20Production%20Tracker.xlsx&action=default&mobileredirect=true&DefaultItemOpen=1) — global FEI/FTTF milestone view with a color-coded Stakeholder View tab; ADO remains the source of truth. A durable Monday 10:00 AM Pacific task creates a verified Outlook status draft for Alyssa and Terence, with Sara CC'd, but never sends it automatically.
