...
| `production-schedule` / `fabric-production-schedule` | Builds reusable production-schedule presets for the team; Sara's personal Fabric preset continues to manage FTTF/FEI timelines, Outlook entries, review drafts, V2 reminders, and publishing alerts. | Team version: [Draft PR #230](https://github.com/microsoft/mvp-copilot-plugins/pull/230) — Golnaz's feedback addressed 8/12; awaiting re-review. Personal preset: [open skill](file:///C:/Users/sfinkelstein/.copilot/skills/fabric-production-schedule/SKILL.md) |
